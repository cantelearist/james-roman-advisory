        ...
        <div className="portal-dialog-overlay" role="dialog" aria-modal="true" aria-labelledby="invite-user-title">
          ...
          <section className="portal-dialog portal-save-dialog">
            ...
            <form onSubmit={sendInvitation}>
              ...
              {isSuperAdmin && <label className="portal-field"><span>Admin scope</span><select name="accessScope" defaultValue="assigned"><option value="assigned">Assigned engagements only</option><option value="global">Global portfolio</option></select></label>}
          ...
          <aside className="portal-drawer portal-access-drawer">
            ...
            <form onSubmit={saveUser}>
              ...
              <div className="portal-form-grid">
                <label className="portal-field"><span>Access scope</span><select name="accessScope" defaultValue={editingUser.accessScope || "assigned"}><option value="assigned">Assigned</option><option value="global">Global</option></select></label>
              ...
              <div className="portal-access-warning"><ShieldAlert size={15} /><span>Saving authority changes revokes existing sessions. Global scope exposes all engagements permitted by the profile.</span></div>
